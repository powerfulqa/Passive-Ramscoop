...
## [0.7.1] - 2025-10-13
### Changed
- Removed legacy colour string keys from LunaLib settings for cleaner UI
- Eliminated duplicate legacy entries in settings menu - only Colour picker entries remain
...
### Changed
- Reworked Notification UI: grouped Nebula and Corona notification settings and removed legacy colour preset radios in favour of LunaLib HSV colour pickers.
- Default notification colours changed to light grey (#D3D3D3).
